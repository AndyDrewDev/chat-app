...
const style = {
  appContainer: `max-w-[1024px] mx-auto px-4 relative`,
  mainContent: `flex flex-col md:flex-row gap-4`,
  chatContainer: `flex-1 relative mt-0 md:mt-10 flex h-[90vh] flex-col border-none bg-gray-100 shadow-xl`,
